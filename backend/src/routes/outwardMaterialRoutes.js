...
router.get('/', authMiddleware, roleMiddleware(['store_manager', 'md']), outwardMaterialRequestController.getOutwardMaterialRequests);
router.get('/:id', authMiddleware, roleMiddleware(['store_manager', 'md']), outwardMaterialRequestController.getOutwardMaterialRequestById);
